<%-- 
    Document   : Cart
    Created on : Feb 12, 2019, 2:03:07 PM
    Author     : LENOVO
--%>
        ...
        <td valign="top" rowspan="200" colspan="80">
            <table>
                ...
                <c:set var="Destination" value="$(sessionScope.selDestination)"/>
                    ...
                    <td><font color='darkblue' size='+1'><a href='<c:url value="TourPackagePage.jsp"/>'>Tour Packages</a></td>
                    <td width='350'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <ct:UserNameTagHandler/>
                    </tr>
            </table>
            <br>
            <form align ='center' color='darkblue' size='+1'>You have added the following contents to your cart:
                </font>
                <br/>
                <br/>
                <br/>
