    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(requestingPageName.equals("Destination"))
            {
                ...
                RequestDispatcher dispatch = getServletContext().getRequestDispatcher("Hotels.jsp");
            }
            else if(requestingPageName.equals("Hotels"))
            {
                ...
                RequestDispatcher dispatch = getServletContext().getRequestDispatcher("Flights.jsp");
            ...
            else if(requestingPageName.equals("FlightsServlet"))
            {
                ...
                RequestDispatcher dispatch = getServletContext().getRequestDispatcher("Cart.jsp");
                dispatch.forward(request, response);
            }
